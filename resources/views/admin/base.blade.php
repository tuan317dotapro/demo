...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.html">Start Page</a>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="{{ route('admin.staff') }}">Staff</a>
    ...
    <script type="text/javascript">
          ...
          $(function(){
            $('#btnSearch').click(function() {
              ...
              if (keyword.length > 0) {
                window.location.href = "{{ route('admin.staff') }}" + "?q="+keyword;
              }
            });
          });
        </script>
